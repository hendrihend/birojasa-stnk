    ...
    <form action="{{ route('vehicles.update', $vehicle->id) }}"
        ...
        <div class="mb-5">
            ...
            <input
                ...
                required
                class="block w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm uppercase text-gray-700 shadow-sm
                       focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-200"
            >
        </div>
        ...
        <div class="mb-6">
            ...
            <p class="mt-1.5 text-xs text-gray-500">
                Isi jika nama yang tercetak di STNK berbeda dengan nama klien.
            </p>
        </div>
