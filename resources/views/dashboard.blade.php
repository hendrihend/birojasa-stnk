...
@section ('content')
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
            ...
            {{-- Jatuh Tempo --}}
            <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                <p class="text-sm text-gray-500">Jatuh Tempo (90 Hari)</p>

                <h3 class="mt-2 text-2xl font-bold text-orange-500">{{ $alerts->count() }}</h3>
            </div>

            {{-- Proses Pengurusan --}}
            <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                <p class="text-sm text-gray-500">Proses Pengurusan</p>

                <h3 class="mt-2 text-2xl font-bold text-blue-600">{{ $kendaraanDiproses }}</h3>
            </div>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm lg:col-span-2">
                <div class="mb-5">
                    <h2 class="text-lg font-semibold text-gray-800">Pengurusan STNK</h2>

                    <p class="text-sm text-gray-500">Jumlah pengurusan STNK per bulan</p>
                </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                <div class="mb-5">
                    <h2 class="text-lg font-semibold text-gray-800">Status Pengurusan</h2>

                    <p class="text-sm text-gray-500">Distribusi status kendaraan</p>
                </div>
                        ...
                        <tbody id="alertTableBody" class="divide-y divide-gray-100">
                            @forelse ($alerts as $index => $alert)
                                <tr class="alert-row hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 text-gray-600">{{ $alert->tipe }}</td>

                                    <td class="px-6 py-4 text-gray-600">{{ $alert->layanan }}</td>
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a
                                            ...
                                            class="inline-block rounded-lg bg-red-500 px-3 py-2 text-xs font-medium text-white transition hover:bg-red-600"
                                        >
                                            Urus Sekarang
                                        </a>
                                    </td>
