                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="total_biaya" value="{{ old('total_biaya') }}" required placeholder="Contoh: 1500000" min="0"
                        ...
                        <p class="text-[11px] text-gray-500 mt-1">Masukkan angka saja tanpa titik (Contoh: 1500000)</p>
                    </div>
