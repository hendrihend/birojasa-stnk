    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="relative">
            ...
            <div class="pointer-events-none absolute inset-y-0 left-0 z-10 flex items-center pl-3 z-10">
            <svg
        ...
        >
            ...
            @foreach($vehicles as $veh)
                ...
                <button
                    type="button"
                    class="vehicle-option block w-full border-b border-gray-100 px-4 py-3 text-left
            ...
            <div class="mb-5">
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        required
                        min="0"
                        class="block w-full rounded-lg border border-gray-300 py-2.5 pl-10 pr-3
                            text-sm text-gray-700 shadow-sm
                            focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-200"
                    >
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (hiddenInput.value) {
            ...
            if (selectedOption) {
                ...
                selectedNopol.textContent =
                    selectedOption.dataset.nopol;
