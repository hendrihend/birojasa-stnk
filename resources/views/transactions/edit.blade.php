    ...
    >
        ...
        <div class="mb-5">
            ...
            <select
                ...
                name="status_proses"
                required
                class="block w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm text-gray-700 shadow-sm
        ...
        <div class="mb-5">
            ...
            <div class="relative">
                ...
                <input
                    ...
                    required
                    min="0"
                    class="block w-full rounded-lg border border-gray-300 py-2.5 pl-10 pr-3 text-sm text-gray-700 shadow-sm
                           focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-200"
                >
        ...
        <div class="mb-6">
            ...
            <input
                ...
                class="block w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm text-gray-700 shadow-sm
                       focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-200"
            >

            <p class="mt-2 text-xs text-gray-500">
                Jika status diubah menjadi
                <span class="font-medium text-gray-700">Selesai</span>
                dan tanggal dikosongkan, tanggal akan otomatis diisi dengan hari ini.
            </p>
        ...
        <div class="flex items-center justify-end gap-3 border-t border-gray-100 pt-5">
            ...
            <button
                type="submit"
                class="rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm
