...
@section ('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-lg font-semibold text-gray-800">Data Pajak & STNK</h2>

                <p class="mt-1 text-sm text-gray-500">Monitoring jadwal jatuh tempo pajak kendaraan.</p>
            </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                {{-- Search kendaraan --}}
                <div>
                    <label for="searchVehicle" class="mb-2 block text-sm font-medium text-gray-700">
                        Cari Kendaraan
                    </label>
                ...
                {{-- Filter jatuh tempo --}}
                <div>
                    <label for="filterTempo" class="mb-2 block text-sm font-medium text-gray-700">
                        Jatuh Tempo
                    </label>
        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                ...
                <table class="min-w-full text-left text-sm">
                    <thead class="border-b border-gray-200 bg-gray-50">
                        <tr>
                            ...
                            <th
                                class="whitespace-nowrap px-5 py-4 text-center font-semibold text-gray-700"
                            >
                                Aksi
                            </th>
                        </tr>
                            ...
                            >
                                ...
                                <td class="px-5 py-4 text-center">
                                    <form
                                        ...
                                        method="POST"
                                        onsubmit="
                                            return confirm('Yakin ingin menghapus data STNK ini?');
                                        "
                                    >
                                        @csrf
                                        @method ('DELETE')
                            ...
                            <tr>
                                <td colspan="6" class="px-5 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-sm font-medium text-gray-500">Belum ada data STNK/Pajak.</p>
                                    </div>
                                </td>
                            </tr>
            ...
            @if ($records->count() > 0)
                <div class="border-t border-gray-200 bg-gray-50 px-5 py-3">
                    <p class="text-sm text-gray-500">Menampilkan
                    <span class="font-semibold text-gray-700"> {{ $records->count() }} </span>
                    data STNK/Pajak</p>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function filterTable() {
                ...
                rows.forEach(function (row) {
                    ...
                    // Filter status
                    const matchStatus = statusValue === 'all' || statusData === statusValue;
                    ...
                    if (tempoValue === 'terlewat') {
                        ...
                        matchTempo = tempoData >= 0 && tempoData <= 30;
                    } else if (tempoValue === '60') {
                        matchTempo = tempoData >= 0 && tempoData <= 60;
                    } else if (tempoValue === '90') {
                        matchTempo = tempoData >= 0 && tempoData <= 90;
                    }

                    // Tampilkan / sembunyikan
                    if (matchSearch && matchStatus && matchTempo) {
            ...
            tempoFilter.addEventListener('change', filterTable);
        });
    </script>
