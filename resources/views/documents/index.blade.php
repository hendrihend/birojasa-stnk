            ...
            <div class="flex items-center gap-3">
                ...
                >
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 17h8m-9-4h10M5 17h-.5A2.5 2.5 0 012 14.5v-4A2.5 2.5 0 014.5 8H6l1.5-3h9L18 8h1.5a2.5 2.5 0 012.5 2.5v4a2.5 2.5 0 01-2.5 2.5H19M7 17a2 2 0 104 0m2 0a2 2 0 104 0" />
                    </svg>
                </div>

                <div>
                    <p class="text-xs font-medium uppercase tracking-wide text-indigo-500">Kendaraan</p>

                    <p class="text-lg font-bold text-gray-800">{{ $vehicle->nopol }}</p>
                </div>
            </div>
        </div>
                ...
                <div class="rounded-xl border border-gray-200 bg-white shadow-sm">
                    ...
                    <div class="border-b border-gray-200 px-5 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-800">Unggah Dokumen Baru</h3>

                                <p class="mt-0.5 text-xs text-gray-500">Tambahkan dokumen kendaraan</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-5">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div
                                    class="rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-4 transition hover:border-indigo-400 hover:bg-indigo-50"
                                >
                                    <input
                                        type="file"
                                        name="file_dokumen"
                                    ...
                                    <div class="mt-2 flex items-center gap-2 text-xs text-gray-500">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-8h.01M12 22a10 10 0 100-20 10 10 0 000 20z" />
                                        </svg>

                                        <span> Format JPG, PNG atau PDF. Maksimal 2MB. </span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                    ...
                    <div class="border-b border-gray-200 px-5 py-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <div
                                    class="flex h-9 w-9 items-center justify-center rounded-lg bg-gray-100 text-gray-600"
                                >
                                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path
                                ...
                                <div>
                                    ...
                                    <p class="mt-0.5 text-xs text-gray-500">Dokumen kendaraan yang telah diunggah</p>
                                </div>
                            </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full text-left text-sm">
                            <thead class="border-b border-gray-200 bg-gray-50">
                                <tr>
                                    <th
                                        class="whitespace-nowrap px-5 py-3.5 font-semibold text-gray-700"
                                    >
                                        Jenis Dokumen
                                    </th>
                                    ...
                                    <th
                                        class="whitespace-nowrap px-5 py-3.5 text-center font-semibold text-gray-700"
                                    >
                                        Aksi
                                    </th>
                                </tr>
                                    ...
                                    <tr class="transition hover:bg-gray-50">
                                        ...
                                        <td class="px-5 py-4 text-center">
                                            <form
                                                ...
                                                onsubmit="
                                                    return confirm(
                                                        'Yakin ingin menghapus dokumen ini secara permanen?'
                                                    );
                                                "
                                            >
                                                @csrf
                                    ...
                                    <tr>
                                        <td colspan="4" class="px-5 py-12 text-center">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="text-sm font-medium text-gray-500">Belum ada dokumen</p>

                                                <p class="mt-1 text-xs text-gray-400">Belum ada dokumen yang diunggah untuk kendaraan ini.</p>
                                            </div>
                                        </td>
                                    </tr>
